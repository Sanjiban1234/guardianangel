...
export interface RideWeatherSafetyResponse { current: NormalizedWeather | null; destination: NormalizedWeather | null; ahead: Array<{ location: WeatherPoint; weather: NormalizedWeather | null; progress?: number }>; advisories: WeatherAdvisory[]; fetchedAt: string; reason?: 'no_location_data' | 'provider_unavailable'; }
