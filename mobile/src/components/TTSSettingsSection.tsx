...
const styles = StyleSheet.create({
  ...
  title: { color: '#F0FDF4', fontSize: 17, fontWeight: '800' },
  copy: { color: '#A3B8A8', fontSize: 12, lineHeight: 17 },
  ...
  selectedChip: { backgroundColor: '#14532D', borderColor: '#4ADE80' },
  chipText: { color: '#A3B8A8', fontSize: 12, fontWeight: '700' }, selectedText: { color: '#F0FDF4' },
  ...
  stop: { flex: 1, borderColor: '#DC2626', borderWidth: 1, borderRadius: 10, padding: 12, alignItems: 'center' }, stopText: { color: '#F87171', fontWeight: '800' },
